                ...
                onTap: () {
                  ...
                  showModalBottomSheet( backgroundColor: Colors.black12,context: context, builder: (context) {
                    return Column(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [
                        Text('Result Weight',style:TextStyle(color: Colors.pink,fontSize: 30,),),
                        Obx(() =>  Text('${h1.result.value.toInt()}',style:TextStyle(color: Colors.white,fontSize: 50,fontWeight: FontWeight.w500))),
                        Text('You are normal !',style:TextStyle(letterSpacing: 1,color: Colors.green,fontSize: 30,),textAlign: TextAlign.center),
                      ],
                    );
                  },);
                },
    ...
    return Obx(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: h1.isMale.isTrue ? Colors.pink : Colors.white12,
  ...
  Obx fbox() {
    return Obx(
        ...
        child: Container(
          ...
          width: 150,
          decoration: BoxDecoration(
            color: h1.isMale.isTrue ? Colors.white12 : Colors.pink,
            borderRadius: BorderRadius.circular(15),
          ),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.spaceAround,
